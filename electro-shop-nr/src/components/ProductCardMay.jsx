  ...
  return (
    ...
    >
      <div className="relative">
       ...
       <div className="xl:p-4 xs:p-1 flex flex-col justify-between flex-grow text-sm font-sans text-gray-500">
        ...
        <button className=" bg-black text-white px-4 py-2 hover:bg-zinc-600 transition-colors duration-300 w-full">
          Comprar
        </button>
        </div>
        </div>
